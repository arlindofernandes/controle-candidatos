...
public class ProcessoSeletivo{
      ...
      public static void main(String[] args) {
        ...
        String[] candidatos = {"Gabriel", "Juliana", "Rafael", "Fernanda", "Miguel", "Camila", "Eduardo", "Larissa", "Felipe", "Amanda"};
    ...
    static void selecaoCandidatos() {
        String[] candidatos = {"Matheus", "Laura", "Vinícius", "Beatriz", "Henrique", "Mariana", "Thiago", "Luiza", "Leonardo", "Natália"};
